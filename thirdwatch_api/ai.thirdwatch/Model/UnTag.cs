...
namespace ai.thirdwatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UnTag :  IEquatable<UnTag>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The type of abuse for which you want to untag user. It&#39;s important to send a untag specific to the type of abuse. You&#39;ll end up with more accurate results this way. e.g. _paymentAbuse, _contentAbuse, _promotionAbuse, _accountAbuse If you wants to untag from all type of abuses than don&#39;t send this parameter.</value>
        ...
        {
            return this.Equals(input as UnTag);
        }

        /// <summary>
        /// Returns true if UnTag instances are equal
        /// </summary>
        /// <param name="input">Instance of UnTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnTag input)
        {
            if (input == null)
                return false;
