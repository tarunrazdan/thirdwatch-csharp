...
namespace ai.thirdwatch.Model
{
    ...
    public partial class Custom :  IEquatable<Custom>, IValidatableObject
    {
        ...
        public Custom(string userId = default(string), string sessionId = default(string), string deviceIp = default(string), string originTimestamp = default(string), CustomInfo customInfo = default(CustomInfo))
        {
            this.userId = userId;
