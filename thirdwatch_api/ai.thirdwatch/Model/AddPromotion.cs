...
namespace ai.thirdwatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddPromotion :  IEquatable<AddPromotion>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Contains all promotions that have been newly applied to the referenced user.</value>
        ...
        {
            return this.Equals(input as AddPromotion);
        }

        /// <summary>
        /// Returns true if AddPromotion instances are equal
        /// </summary>
        /// <param name="input">Instance of AddPromotion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddPromotion input)
        {
            if (input == null)
                return false;
