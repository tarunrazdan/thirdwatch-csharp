...
namespace ai.thirdwatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoveFromCart :  IEquatable<RemoveFromCart>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveFromCart" /> class.
        /// </summary>
        ...
        public RemoveFromCart(string userId = default(string), string sessionId = default(string), string deviceIp = default(string), string originTimestamp = default(string), Item item = default(Item), CustomInfo customInfo = default(CustomInfo))
        {
            this.userId = userId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemoveFromCart {\n");
        ...
        {
            return this.Equals(input as RemoveFromCart);
        }

        /// <summary>
        /// Returns true if RemoveFromCart instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveFromCart to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveFromCart input)
        {
            if (input == null)
                return false;
