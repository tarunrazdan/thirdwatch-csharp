...
namespace ai.thirdwatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomInfo : Dictionary<String, string>,  IEquatable<CustomInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public CustomInfo() : base()
        {
        }
        ...
        {
            return this.Equals(input as CustomInfo);
        }
