...
namespace ai.thirdwatch.Model
{
    ...
    public partial class Tag :  IEquatable<Tag>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Indicates whether a user is engaging in behavior deemed harmful to your business. Set to true if the user is engaging in abusive activity. Set to false if the user is engaging in valid activity.</value>
        [DataMember(Name="_isBad", EmitDefaultValue=false)]
        public bool? isBad { get; set; }

        /// <summary>
        /// The type of abuse for which you want to send a tag. It&#39;s important to send a tag specific to the type of abuse the user is committing so that thirdwatch can learn about specific patterns of behavior. You&#39;ll end up with more accurate results this way. e.g. _paymentAbuse, _contentAbuse, _promotionAbuse, _accountAbuse
        /// </summary>
        /// <value>The type of abuse for which you want to send a tag. It&#39;s important to send a tag specific to the type of abuse the user is committing so that thirdwatch can learn about specific patterns of behavior. You&#39;ll end up with more accurate results this way. e.g. _paymentAbuse, _contentAbuse, _promotionAbuse, _accountAbuse</value>
        [DataMember(Name="_abuseType", EmitDefaultValue=false)]
        public string abuseType { get; set; }

        /// <summary>
        /// The text content of the tag.Useful as annotation on why the label was added.
        /// </summary>
        /// <value>The text content of the tag.Useful as annotation on why the label was added.</value>
        ...
        /// </summary>
        /// <value>String describing the original source of the tag information (e.g. payment gateway, manual review, etc.).</value>
        ...
        /// </summary>
        /// <value>Unique identifier (e.g. email address) of the analyst who applied the label. Useful for tracking purposes after the fact.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  isBad: ").Append(isBad).Append("\n");
            sb.Append("  abuseType: ").Append(abuseType).Append("\n");
        ...
        public bool Equals(Tag input)
        {
            ...
            return 
                ...
                (
                    this.isBad == input.isBad ||
                    (this.isBad != null &&
                    this.isBad.Equals(input.isBad))
                ) && 
                (
                    this.abuseType == input.abuseType ||
                    (this.abuseType != null &&
                    this.abuseType.Equals(input.abuseType))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.isBad != null)
                    hashCode = hashCode * 59 + this.isBad.GetHashCode();
                if (this.abuseType != null)
                    hashCode = hashCode * 59 + this.abuseType.GetHashCode();
