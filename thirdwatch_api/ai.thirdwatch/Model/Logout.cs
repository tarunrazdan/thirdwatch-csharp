...
namespace ai.thirdwatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Logout :  IEquatable<Logout>, IValidatableObject
    {
        /// <summary>
        ...
        public Logout(string userId = default(string), string sessionId = default(string), string deviceIp = default(string), string originTimestamp = default(string), CustomInfo customInfo = default(CustomInfo))
        {
            this.userId = userId;
