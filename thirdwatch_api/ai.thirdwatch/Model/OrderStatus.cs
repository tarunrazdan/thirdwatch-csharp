...
namespace ai.thirdwatch.Model
{
    ...
    public partial class OrderStatus :  IEquatable<OrderStatus>, IValidatableObject
    {
        ...
        /// <param name="_orderStatus">Indicates the high-level state of the order. e.g. _approved, _canceled, _held, _fulfilled, _returned, _rto.</param>
        ...
        public OrderStatus(string userId = default(string), string sessionId = default(string), string orderId = default(string), string _orderStatus = default(string), string reason = default(string), string shippingCost = default(string), string trackingNumber = default(string), string trackingMethod = default(string), string source = default(string), string analyst = default(string), string description = default(string), CustomInfo customInfo = default(CustomInfo))
        {
            this.userId = userId;
        ...
        [DataMember(Name="_orderStatus", EmitDefaultValue=false)]
