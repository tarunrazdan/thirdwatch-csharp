...
namespace ai.thirdwatch.Model
{
    ...
    public partial class Login :  IEquatable<Login>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Use _loginStatus to represent the success or failure of the login attempt. e.g. _success, _failure</value>
        [DataMember(Name="_loginStatus", EmitDefaultValue=false)]
        ...
        public bool Equals(Login input)
        {
            ...
            return 
                ...
                (
                    this.loginStatus == input.loginStatus ||
                    (this.loginStatus != null &&
                    this.loginStatus.Equals(input.loginStatus))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.loginStatus != null)
                    hashCode = hashCode * 59 + this.loginStatus.GetHashCode();
