...
namespace ai.thirdwatch.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinkSessionToUser :  IEquatable<LinkSessionToUser>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The user&#39;s current session ID, used to associate session id with user id.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LinkSessionToUser {\n");
        ...
        {
            return this.Equals(input as LinkSessionToUser);
        }

        /// <summary>
        /// Returns true if LinkSessionToUser instances are equal
        /// </summary>
        /// <param name="input">Instance of LinkSessionToUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkSessionToUser input)
        {
            if (input == null)
                return false;
