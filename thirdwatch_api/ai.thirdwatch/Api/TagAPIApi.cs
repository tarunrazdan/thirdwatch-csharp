...
namespace ai.thirdwatch.Api
{
    ...
    /// </summary>
    public interface ITagAPIApi : IApiAccessor
    {
        ...
        /// <param name="JSON">Pass user and it&#39;s info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain tag info.</param>
        ...
        ApiResponse<EventResponse> TagUserWithHttpInfo (Tag JSON);
        ...
        System.Threading.Tasks.Task<EventResponse> TagUserAsync (Tag JSON);
        ...
        System.Threading.Tasks.Task<ApiResponse<EventResponse>> TagUserAsyncWithHttpInfo (Tag JSON);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TagAPIApi : ITagAPIApi
    {
        ...
        /// <returns></returns>
        public TagAPIApi(Configuration configuration = null)
        {
        ...
        /// <summary>
        /// The Tag API enables you to tell Thirdwatch which of your users are bad and which are good. By telling us who is bad and who is good, we can identify patterns that are unique to your business. Once you give this feedback, the platform instantly analyzes it and learns to identify good and bad behavior of other users more accurately. If you want to change an existing label for a user - for example, from bad to good - all you need to do is send a new label and we&#39;ll overwrite the existing value. 
        /// </summary>
        /// <exception cref="ai.thirdwatch.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="JSON">Pass user and it&#39;s info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain tag info.</param>
        /// <returns>EventResponse</returns>
        public EventResponse TagUser (Tag JSON)
        {
             ApiResponse<EventResponse> localVarResponse = TagUserWithHttpInfo(JSON);
        ...
        /// <param name="JSON">Pass user and it&#39;s info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain tag info.</param>
        /// <returns>ApiResponse of EventResponse</returns>
        public ApiResponse< EventResponse > TagUserWithHttpInfo (Tag JSON)
        {
            // verify the required parameter 'JSON' is set
            if (JSON == null)
                throw new ApiException(400, "Missing required parameter 'JSON' when calling TagAPIApi->TagUser");

            var localVarPath = "/v1/tag";
            ...
            {
                Exception exception = ExceptionFactory("TagUser", localVarResponse);
        ...
        /// <param name="JSON">Pass user and it&#39;s info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain tag info.</param>
        /// <returns>Task of EventResponse</returns>
        public async System.Threading.Tasks.Task<EventResponse> TagUserAsync (Tag JSON)
        {
             ApiResponse<EventResponse> localVarResponse = await TagUserAsyncWithHttpInfo(JSON);
             return localVarResponse.Data;
        ...
        /// <param name="JSON">Pass user and it&#39;s info to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain tag info.</param>
        /// <returns>Task of ApiResponse (EventResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EventResponse>> TagUserAsyncWithHttpInfo (Tag JSON)
        {
            // verify the required parameter 'JSON' is set
            if (JSON == null)
                throw new ApiException(400, "Missing required parameter 'JSON' when calling TagAPIApi->TagUser");
