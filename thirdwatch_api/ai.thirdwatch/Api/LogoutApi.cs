...
namespace ai.thirdwatch.Api
{
    ...
    public interface ILogoutApi : IApiAccessor
    {
        ...
        /// <param name="JSON">Pass logout status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain logout info.</param>
        ...
        ApiResponse<EventResponse> LogoutWithHttpInfo (Logout JSON);
        ...
        System.Threading.Tasks.Task<EventResponse> LogoutAsync (Logout JSON);
        ...
        System.Threading.Tasks.Task<ApiResponse<EventResponse>> LogoutAsyncWithHttpInfo (Logout JSON);
    ...
    public partial class LogoutApi : ILogoutApi
    {
        ...
        /// <param name="JSON">Pass logout status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain logout info.</param>
        /// <returns>EventResponse</returns>
        public EventResponse Logout (Logout JSON)
        {
             ApiResponse<EventResponse> localVarResponse = LogoutWithHttpInfo(JSON);
        ...
        /// <param name="JSON">Pass logout status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain logout info.</param>
        /// <returns>ApiResponse of EventResponse</returns>
        public ApiResponse< EventResponse > LogoutWithHttpInfo (Logout JSON)
        {
            // verify the required parameter 'JSON' is set
            if (JSON == null)
                throw new ApiException(400, "Missing required parameter 'JSON' when calling LogoutApi->Logout");

            var localVarPath = "/v1/logout";
        ...
        /// <param name="JSON">Pass logout status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain logout info.</param>
        /// <returns>Task of EventResponse</returns>
        public async System.Threading.Tasks.Task<EventResponse> LogoutAsync (Logout JSON)
        {
             ApiResponse<EventResponse> localVarResponse = await LogoutAsyncWithHttpInfo(JSON);
             return localVarResponse.Data;
        ...
        /// <param name="JSON">Pass logout status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain logout info.</param>
        /// <returns>Task of ApiResponse (EventResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EventResponse>> LogoutAsyncWithHttpInfo (Logout JSON)
        {
            // verify the required parameter 'JSON' is set
            if (JSON == null)
                throw new ApiException(400, "Missing required parameter 'JSON' when calling LogoutApi->Logout");
