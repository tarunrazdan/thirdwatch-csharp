...
namespace ai.thirdwatch.Api
{
    ...
    /// </summary>
    public interface ICreateOrderApi : IApiAccessor
    {
        ...
        ApiResponse<EventResponse> CreateOrderWithHttpInfo (CreateOrder body);
        ...
        System.Threading.Tasks.Task<EventResponse> CreateOrderAsync (CreateOrder body);
        ...
        System.Threading.Tasks.Task<ApiResponse<EventResponse>> CreateOrderAsyncWithHttpInfo (CreateOrder body);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CreateOrderApi : ICreateOrderApi
    {
        private ai.thirdwatch.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrderApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CreateOrderApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CreateOrderApi(Configuration configuration = null)
        {
        ...
        /// <param name="body">An order to submit for review. Only &#x60;_userID&#x60; is required field. But this should contain order info.</param>
        /// <returns>ApiResponse of EventResponse</returns>
        public ApiResponse< EventResponse > CreateOrderWithHttpInfo (CreateOrder body)
        {
