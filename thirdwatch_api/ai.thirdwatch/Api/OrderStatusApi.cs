...
namespace ai.thirdwatch.Api
{
    ...
    /// </summary>
    public interface IOrderStatusApi : IApiAccessor
    {
        ...
        /// <param name="JSON">Pass order status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain order info.</param>
        ...
        ApiResponse<EventResponse> OrderStatusWithHttpInfo (OrderStatus JSON);
        ...
        System.Threading.Tasks.Task<EventResponse> OrderStatusAsync (OrderStatus JSON);
        ...
        System.Threading.Tasks.Task<ApiResponse<EventResponse>> OrderStatusAsyncWithHttpInfo (OrderStatus JSON);
    ...
    public partial class OrderStatusApi : IOrderStatusApi
    {
        ...
        /// <param name="JSON">Pass order status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain order info.</param>
        /// <returns>EventResponse</returns>
        public EventResponse OrderStatus (OrderStatus JSON)
        {
             ApiResponse<EventResponse> localVarResponse = OrderStatusWithHttpInfo(JSON);
        ...
        /// <param name="JSON">Pass order status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain order info.</param>
        /// <returns>ApiResponse of EventResponse</returns>
        public ApiResponse< EventResponse > OrderStatusWithHttpInfo (OrderStatus JSON)
        {
            // verify the required parameter 'JSON' is set
            if (JSON == null)
                throw new ApiException(400, "Missing required parameter 'JSON' when calling OrderStatusApi->OrderStatus");

            var localVarPath = "/v1/order_status";
            ...
            {
                Exception exception = ExceptionFactory("OrderStatus", localVarResponse);
        ...
        /// <param name="JSON">Pass order status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain order info.</param>
        /// <returns>Task of EventResponse</returns>
        public async System.Threading.Tasks.Task<EventResponse> OrderStatusAsync (OrderStatus JSON)
        {
             ApiResponse<EventResponse> localVarResponse = await OrderStatusAsyncWithHttpInfo(JSON);
             return localVarResponse.Data;
        ...
        /// <param name="JSON">Pass order status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain order info.</param>
        /// <returns>Task of ApiResponse (EventResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EventResponse>> OrderStatusAsyncWithHttpInfo (OrderStatus JSON)
        {
            // verify the required parameter 'JSON' is set
            if (JSON == null)
                throw new ApiException(400, "Missing required parameter 'JSON' when calling OrderStatusApi->OrderStatus");
