...
namespace ai.thirdwatch.Api
{
    ...
    /// </summary>
    public interface IItemStatusApi : IApiAccessor
    {
        ...
        ApiResponse<EventResponse> ItemStatusWithHttpInfo (ItemStatus JSON);
        ...
        System.Threading.Tasks.Task<EventResponse> ItemStatusAsync (ItemStatus JSON);
        ...
        System.Threading.Tasks.Task<ApiResponse<EventResponse>> ItemStatusAsyncWithHttpInfo (ItemStatus JSON);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ItemStatusApi : IItemStatusApi
    {
        private ai.thirdwatch.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ItemStatusApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ItemStatusApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ItemStatusApi(Configuration configuration = null)
        {
        ...
        /// <param name="JSON">Pass change item status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain item status.</param>
        /// <returns>EventResponse</returns>
        public EventResponse ItemStatus (ItemStatus JSON)
        {
             ApiResponse<EventResponse> localVarResponse = ItemStatusWithHttpInfo(JSON);
        ...
        /// <param name="JSON">Pass change item status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain item status.</param>
        /// <returns>ApiResponse of EventResponse</returns>
        public ApiResponse< EventResponse > ItemStatusWithHttpInfo (ItemStatus JSON)
        {
        ...
        /// <param name="JSON">Pass change item status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain item status.</param>
        /// <returns>Task of EventResponse</returns>
        public async System.Threading.Tasks.Task<EventResponse> ItemStatusAsync (ItemStatus JSON)
        {
             ApiResponse<EventResponse> localVarResponse = await ItemStatusAsyncWithHttpInfo(JSON);
             return localVarResponse.Data;
