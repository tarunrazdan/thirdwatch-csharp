...
namespace ai.thirdwatch.Api
{
    ...
    /// </summary>
    public interface ISubmitReviewApi : IApiAccessor
    {
        ...
        ApiResponse<EventResponse> SubmitReviewWithHttpInfo (SubmitReview JSON);
        ...
        System.Threading.Tasks.Task<EventResponse> SubmitReviewAsync (SubmitReview JSON);
        ...
        System.Threading.Tasks.Task<ApiResponse<EventResponse>> SubmitReviewAsyncWithHttpInfo (SubmitReview JSON);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SubmitReviewApi : ISubmitReviewApi
    {
        private ai.thirdwatch.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SubmitReviewApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SubmitReviewApi(String basePath)
        {
        ...
        /// <returns></returns>
        public SubmitReviewApi(Configuration configuration = null)
        {
        ...
        /// <param name="JSON">Pass review to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain review info.</param>
        /// <returns>ApiResponse of EventResponse</returns>
        public ApiResponse< EventResponse > SubmitReviewWithHttpInfo (SubmitReview JSON)
        {
