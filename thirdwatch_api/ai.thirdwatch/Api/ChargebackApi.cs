...
namespace ai.thirdwatch.Api
{
    ...
    public interface IChargebackApi : IApiAccessor
    {
        ...
        ApiResponse<EventResponse> ChargebackWithHttpInfo (Chargeback JSON);
        ...
        System.Threading.Tasks.Task<EventResponse> ChargebackAsync (Chargeback JSON);
        ...
        System.Threading.Tasks.Task<ApiResponse<EventResponse>> ChargebackAsyncWithHttpInfo (Chargeback JSON);
    ...
    public partial class ChargebackApi : IChargebackApi
    {
        ...
        /// <param name="JSON">Pass chargeback to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain chargeback info.</param>
        /// <returns>ApiResponse of EventResponse</returns>
        public ApiResponse< EventResponse > ChargebackWithHttpInfo (Chargeback JSON)
        {
