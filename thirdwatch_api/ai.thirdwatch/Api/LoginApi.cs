...
namespace ai.thirdwatch.Api
{
    ...
    public interface ILoginApi : IApiAccessor
    {
        ...
        /// <param name="JSON">Pass login status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain login info.</param>
        ...
        ApiResponse<EventResponse> LoginWithHttpInfo (Login JSON);
        ...
        System.Threading.Tasks.Task<EventResponse> LoginAsync (Login JSON);
        ...
        System.Threading.Tasks.Task<ApiResponse<EventResponse>> LoginAsyncWithHttpInfo (Login JSON);
    ...
    public partial class LoginApi : ILoginApi
    {
        ...
        /// <param name="JSON">Pass login status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain login info.</param>
        /// <returns>EventResponse</returns>
        public EventResponse Login (Login JSON)
        {
             ApiResponse<EventResponse> localVarResponse = LoginWithHttpInfo(JSON);
        ...
        /// <param name="JSON">Pass login status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain login info.</param>
        /// <returns>ApiResponse of EventResponse</returns>
        public ApiResponse< EventResponse > LoginWithHttpInfo (Login JSON)
        {
            // verify the required parameter 'JSON' is set
            if (JSON == null)
                throw new ApiException(400, "Missing required parameter 'JSON' when calling LoginApi->Login");
        ...
        /// <param name="JSON">Pass login status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain login info.</param>
        /// <returns>Task of EventResponse</returns>
        public async System.Threading.Tasks.Task<EventResponse> LoginAsync (Login JSON)
        {
             ApiResponse<EventResponse> localVarResponse = await LoginAsyncWithHttpInfo(JSON);
             return localVarResponse.Data;
        ...
        /// <param name="JSON">Pass login status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain login info.</param>
        /// <returns>Task of ApiResponse (EventResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EventResponse>> LoginAsyncWithHttpInfo (Login JSON)
        {
            // verify the required parameter 'JSON' is set
            if (JSON == null)
                throw new ApiException(400, "Missing required parameter 'JSON' when calling LoginApi->Login");
