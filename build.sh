...
${nuget_cmd} install src/ai.thirdwatch/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/ai.thirdwatch.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/ai.thirdwatch.dll \
-recurse:'src/ai.thirdwatch/*.cs' \
-doc:bin/ai.thirdwatch.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/ai.thirdwatch.dll was created successfully"
fi
